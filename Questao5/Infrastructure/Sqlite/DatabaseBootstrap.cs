...
namespace Questao5.Infrastructure.Sqlite
{
    public class DatabaseBootstrap : IDatabaseBootstrap
    {
        ...
        public void Setup()
        {
            ...
            connection.Execute("INSERT INTO idempotencia(chave_idempotencia, requisicao, resultado) VALUES('INVALID_ACCOUNT_POST', 'MovimentacaoContaCorrente', 'Apenas contas correntes cadastradas podem receber movimentação');");
            connection.Execute("INSERT INTO idempotencia(chave_idempotencia, requisicao, resultado) VALUES('INACTIVE_ACCOUNT_POST', 'MovimentacaoContaCorrente', 'Apenas contas correntes ativas podem receber movimentação');");
            connection.Execute("INSERT INTO idempotencia(chave_idempotencia, requisicao, resultado) VALUES('INVALID_VALUE_POST', 'MovimentacaoContaCorrente', 'Apenas valores positivos podem ser recebidos');");
            connection.Execute("INSERT INTO idempotencia(chave_idempotencia, requisicao, resultado) VALUES('INVALID_TYPE_POST', 'MovimentacaoContaCorrente', 'Apenas os tipos “débito” ou “crédito” podem ser aceitos');");
            connection.Execute("INSERT INTO idempotencia(chave_idempotencia, requisicao, resultado) VALUES('INVALID_ACCOUNT_GET', 'ConsultaContaCorrente', 'Apenas contas correntes cadastradas podem consultar o saldo');");
            connection.Execute("INSERT INTO idempotencia(chave_idempotencia, requisicao, resultado) VALUES('INACTIVE_ACCOUNT_GET', 'ConsultaContaCorrente', 'Apenas contas correntes ativas podem consultar o saldo');");
        }
    }
}
